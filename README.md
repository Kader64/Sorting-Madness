...
- **Random Array** – generowanie losowej tablicy
- **Array length** – określenie długości tablicy
- **Range of drawing numbers** – zakres generowanych liczb
- **Sorted** – wygenerowanie już posortowanej tablicy
- **Reverse Sorted** – wygenerowanie tablicy posortowanej malejąco
- **Custom Array** – możliwość wpisania własnych wartości (np. `1,2,3,4,5`)
...
- **Animation Delay (suwak)** – regulacja prędkości animacji
